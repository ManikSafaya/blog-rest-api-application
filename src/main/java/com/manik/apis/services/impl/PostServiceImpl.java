...
/*		if(sortDir.equalsIgnoreCase("asc")) {
		...
		//Pageable p = PageRequest.of(pageNumber, pageSize,Sort.by(sortBy)); --> sorting by postId
		
		// sortDir is taken as one method argument
	...
	public List<PostDto> searchPostsByKeyword(String keyword) {
		List<Post> posts = this.postRepo.searchPostsByTitle("%"+keyword+"%");
		return posts.stream().map((post)->this.modelMapper.map(post, PostDto.class)).collect(Collectors.toList());
	}

	/*
	 * @Override public List<PostDto> getPostsBySearch(String keyword) { // TODO
	 * Auto-generated method stub List<Post> posts =
	 * this.postRepo.findByTitleContaining(keyword); return
